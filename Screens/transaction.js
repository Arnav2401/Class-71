  ...
  render(){
    if(this.state.buttonstate!='normal'&& this.state.hascamerapermissions){
      ...
      return(
        ...
        <TouchableOpacity style={{borderWidth:3,borderRadius:3,backgroundColor:'black'}} onPress={this.handleTransaction}><Text style={{fontSize:20,textAlign:'center',color:'white'}}>Submit</Text></TouchableOpacity>
